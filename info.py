...
PICS = (environ.get('PICS', 'https://telegra.ph/file/ef432bed5138bd90177c0.jpg')).split()
...
DATABASE_NAME = environ.get('DATABASE_NAME', "Airobot")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# Others
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', 0))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'MOVIES BANK')
